        ...
        <>
            ...
            <div className="flex flex-col sm:flex-row sm:justify-center sm:items-center gap-2 mt-6 select-none">
                <div className="flex justify-center items-center gap-2">
                    <button
                        className="w-9 h-9 rounded flex items-center justify-center text-lg bg-[var(--main-color)] text-gray-300 hover:bg-[var(--main-color)]/80 hover:text-white transition disabled:opacity-50"
                    ...
                    {pageNumbers.map((num, idx) => (
                        <button
                            key={idx}
                            className={`w-9 h-9 rounded flex items-center justify-center text-lg transition ${currentPage === num
                                    ? "bg-[var(--main-color)] text-white hover:bg-[var(--main-color)]/80 hover:text-white font-bold"
                                    : "border border-gray-300 text-[var(--main-color)] hover:bg-[var(--main-color)]/80 hover:text-white  "
                                }`}
